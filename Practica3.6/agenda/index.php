...
control" placeholder="Escribe tu nombre" id="nombre" name="nombre" required>
          ...
          <input type="text" class="form-
control" placeholder="Escribe tus apellidos" id="apellidos" name="apellidos" required>
      </div>
       <div class="form-group">
...
control" id="estadocivil" name="estadocivil" required>
    ...
    <div class="form-group">
       ...
       <input list="origenes" id="origen" name="origen" class="form-
control" placeholder="Escribe el municipio de origen" required>
...
<div class="form-group">
 ...
 <div class="form-group">
     ...
     <input type="text" id="redess" name="redess" class="form-
control" placeholder="Escribe tus redes sociales separados por comas">
 </div>
